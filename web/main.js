...
// Flood-fills '0' cells only (4-connected) to find rooms -- '3' (doorway) cells are
...
const ROOM_PALETTE = [
  0x5a7d6b, 0x6b6a8f, 0x8a6f5a, 0x5a7a8f, 0x8a5a6f,
  0x6f8a5a, 0x5a5a8a, 0x8a7a5a, 0x5a8a7a, 0x7a5a8a,
...
function computeRoomColors(data) {
  ...
  for (let r = 0; r < rows; r++) {
    for (let c = 0; c < cols; c++) {
      if (grid[r][c] !== '0' || roomId[idx(r, c)] !== -1) continue;
      const stack = [[r, c]];
      ...
      while (stack.length) {
        ...
        for (const [dr, dc] of [[-1, 0], [1, 0], [0, -1], [0, 1]]) {
          ...
          if (grid[nr][nc] !== '0' || roomId[idx(nr, nc)] !== -1) continue;
